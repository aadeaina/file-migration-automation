"""Azure adapter: AzCopy (or Azure File Sync) into Azure Files.

Trust into Azure Entra Domain Services means the same near-verbatim ACL
carryover as AWS, so `apply_permissions` is a verification step here too.
"""

from __future__ import annotations

from migration.cloud_adapters.transport import AzCopyTransport, Transport
...
class AzureAdapter:
    def __init__(
        ...
        self._transport = transport or AzCopyTransport()
